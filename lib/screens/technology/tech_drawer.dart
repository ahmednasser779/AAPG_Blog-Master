...
bool closingTechDrawer = false;

class TechDrawer extends StatefulWidget {
  @override
  _TechDrawerState createState() => _TechDrawerState();
}

class _TechDrawerState extends State<TechDrawer> {
  @override
